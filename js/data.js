...
(function() {
  try {
    ...
    if (!versionOk) {
      // Migrar categorías desde data.js sin perder ediciones del usuario
      if (d.photos) {
        var catMap = {};
